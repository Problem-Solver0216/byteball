...
angular.module('copayApp.controllers').controller('recoveryFromSeed',
	function ($rootScope, $scope, $log, $timeout, profileService) {
		...
		var wallet_defined_by_keys = require('millixcore/wallet_defined_by_keys.js');
		var objectHash = require('millixcore/object_hash.js');
		try{
			var ecdsa = require('secp256k1');
		}
		catch(e){
			var ecdsa = require('millixcore/node_modules/secp256k1' + '');
		}
		var Mnemonic = require('bitcore-mnemonic');
		var Bitcore = require('bitcore-lib');
		var db = require('millixcore/db.js');
		var network = require('millixcore/network');
		var myWitnesses = require('millixcore/my_witnesses');
		...
		function cleanAndAddWalletsAndAddresses(assocMaxAddressIndexes) {
			var device = require('millixcore/device');
